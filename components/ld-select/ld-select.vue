<template>
	<view class="main">
		<view class="input" :style="disabled?'background-color:#f5f7fa;font-size:24rpx;color:grey':''">
			<input @click="showModal" v-model="bValue" :style="disabled?'color:#c0c4cc':''" :placeholder="placeholder" disabled/>
			<text v-if="clearable&&!disabled" @click="empty" class="selectIcon iconcross"></text><image src="../../static/select-down.png" style="width: 24rpx; height: 14rpx;"></image>
		</view>
